# -*- coding: utf-8 -*-
"""Clean valeurs foncières 2021.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1U4TIkBrDv_1DsLpEdYZ45_H3x3ZEFD3Y
"""
...
df_valeursfoncieres = pd.read_csv('ValeursFoncieres-2021.txt', sep = '|')
...
df_appartements.loc[df_appartements['Commune'] == 'PARIS 07', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'PARIS 07', 'Code postal'].fillna(75007)
df_appartements.loc[df_appartements['Commune'] == 'LA TESTE-DE-BUCH', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'LA TESTE-DE-BUCH', 'Code postal'].fillna(33120)
...
df_appartements.loc[df_appartements['Commune'] == 'VESINET (LE)', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'VESINET (LE)', 'Code postal'].fillna(78650)
...
df_appartements_cleaned.to_csv('prix_vente_appartement_cleaned_2021.csv')
