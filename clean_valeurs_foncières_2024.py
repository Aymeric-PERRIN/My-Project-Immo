# -*- coding: utf-8 -*-
"""Clean valeurs foncières 2024.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14wg1GQGA1Aj3mKOwni8jyx-rqao1pnaE
"""
...
df_valeursfoncieres = pd.read_csv('ValeursFoncieres-2024-S1 2.txt', sep = '|')
...
df_appartements.loc[df_appartements['Commune'] == 'VALENCE', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'VALENCE', 'Code postal'].fillna(26000)
df_appartements.loc[df_appartements['Commune'] == 'MOIRANS', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'MOIRANS', 'Code postal'].fillna(38430)
...
df_appartements.loc[df_appartements['Commune'] == 'GAP', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'GAP', 'Code postal'].fillna(5000)
df_appartements.loc[df_appartements['Commune'] == 'LES VANS', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'LES VANS', 'Code postal'].fillna(7140)
df_appartements.loc[df_appartements['Commune'] == 'TOULOUSE', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'TOULOUSE', 'Code postal'].fillna(31000)
df_appartements.loc[df_appartements['Commune'] == 'PERPIGNAN', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'PERPIGNAN', 'Code postal'].fillna(66000)
df_appartements.loc[df_appartements['Commune'] == 'LA VALETTE DU VAR', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'LA VALETTE DU VAR', 'Code postal'].fillna(83160)
df_appartements.loc[df_appartements['Commune'] == 'SAINT-LAURENT-D OLT', 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == 'SAINT-LAURENT-D OLT', 'Code postal'].fillna(12560)
df_appartements.loc[df_appartements['Commune'] == "SABLES-D'OLONNE (LES)", 'Code postal'] = df_appartements.loc[df_appartements['Commune'] == "SABLES-D'OLONNE (LES)", 'Code postal'].fillna(85100)
...
df_appartements_cleaned.to_csv('prix_vente_appartement_cleaned_2024.csv')
